...
class OrderTable3(Node):
    def __init__(self):
        super().__init__('order_table3')
        ...
        self.get_logger().info("Order node for TABLE 3 ready.")
...
MENU = """
========================================
  Cafe Butler - Table 3 Order Console
========================================
 [1] Scenario 1 -> TABLE3 (simple delivery)
 [2] Scenario 2 -> TABLE3 (kitchen + table confirm)
 [3] Scenario 3 -> TABLE3 (kitchen confirm; table timeout -> kitchen)
 [4] Scenario 4 -> TABLE3 (cancel-aware delivery)
...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        if choice == '1': node.send(1, "TABLE3")
        elif choice == '2': node.send(2, "TABLE3")
        elif choice == '3': node.send(3, "TABLE3")
        elif choice == '4': node.send(4, "TABLE3")
        ...
        elif choice == 'x': node.cancel('TABLE3')
