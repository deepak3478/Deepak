...
class OrderTable1(Node):
    def __init__(self):
        super().__init__('order_table1')
        ...
        self.get_logger().info("Order node for TABLE 1 ready.")
...
MENU = """
========================================
  Cafe Butler - Table 1 Order Console
========================================
 [1] Scenario 1 -> TABLE1 (simple delivery)
 [2] Scenario 2 -> TABLE1 (kitchen + table confirm)
 [3] Scenario 3 -> TABLE1 (kitchen confirm; table timeout -> kitchen)
 [4] Scenario 4 -> TABLE1 (cancel-aware delivery)
...
def main(args=None):
    ...
    while rclpy.ok():
        ...
        if choice == '1': node.send(1, "TABLE1")
        elif choice == '2': node.send(2, "TABLE1")
        elif choice == '3': node.send(3, "TABLE1")
        elif choice == '4': node.send(4, "TABLE1")
        ...
        elif choice == 'x': node.cancel('TABLE1')
